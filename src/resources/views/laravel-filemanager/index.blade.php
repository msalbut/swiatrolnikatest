...
<head>
  ...
  {{-- <style>{{asset('vendor/unisharp/laravel-filemanager/public/css/lfm.css')}}</style> --}}
...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <div class="form-group navbar-brand d-flex">
        <input type="text" class="form-control mr-2" name="search" id="search_text" value="">
        <button type="submit" class="btn "><i class="fas fa-search" onclick="search()"></i></button>
    </div>
...
{{-- @dd($items); --}}
  ...
  <script src="{{ asset('vendor/laravel-filemanager/js/scriptlfm.js') }}"></script>
<script>
